                ...
                <div className="flex items-center gap-4">
                    ...
                    {user ? (
                        <div className="flex items-center space-x-6">
                            ...
                            <button
                                onClick={logout}
                                className="bg-white/5 hover:bg-white/10 text-white px-4 py-2 rounded-xl transition-all duration-300 border border-white/10 shadow-sm hover:shadow-md font-medium"
                            >
                                Logout
                            </button>
                        </div>
